...
function M.setup()
  ...
  hl(0, "NormalFloat", { fg = c.text, bg = "none" })
  hl(0, "FloatBorder", { fg = c.text, bg = "none" })
  ...
  hl(0, "Pmenu", { fg = c.text, bg = "none" })
  hl(0, "PmenuSel", { fg = c.text, bg = c.shade0 })
  hl(0, "PmenuSbar", { fg = c.text, bg = "none" })
  hl(0, "PmenuThumb", { fg = c.text, bg = "none" })
